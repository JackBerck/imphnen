  ...
  const cards = [
    {
      ...
      desc: "Pelajari konsep programming dengan cara yang mudah dipahami tanpa harus menulis kode yang rumit.",
      color: "bg-purple-tertiary text-purple-base",
      icon: (
        <svg
    ...
    },
    {
      ...
      desc: "Bergabunglah dengan komunitas kami yang supportif dan siap membantu Anda dalam perjalanan belajar Anda.",
      color: "bg-yellow-tertiary text-yellow-base",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 640 512"
    ...
    },
    {
      ...
      desc: "Ikuti tutorial interaktif yang dirancang untuk membantu Anda memahami konsep-konsep programming dengan lebih baik.",
      color: "bg-blue-tertiary text-blue-base",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 640 512"
    ...
    },
    {
      ...
      desc: "Bergabunglah dalam proyek kolaboratif dengan anggota komunitas lainnya untuk meningkatkan keterampilan dan pengalaman Anda.",
      color: "bg-green-tertiary text-green-base",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 640 512"
      ...
      <div className="mx-auto max-w-screen-xl">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {cards.map((card, i) => (
            ...
            >
              <div className={`p-4 rounded-full w-fit mb-2 ${card.color}`}>
                {card.icon}
              </div>
